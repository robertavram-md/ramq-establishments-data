...
# Function to process establishments
def process_establishments(batch_size=50):
    ...
    with open(output_csv_path, 'w', newline='', encoding='utf-8') as outfile:
        ...
        for i, establishment in enumerate(establishments):
            if i % batch_size == 0:
                print(f"Processing batch {i//batch_size + 1}/{(total//batch_size) + 1} ({i}/{total})")
...
if __name__ == "__main__":
    ...
    process_establishments(batch_size=10)  # Process in smaller batches to show progress
