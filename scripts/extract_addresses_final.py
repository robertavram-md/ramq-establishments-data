...
csv_file_path = "/home/ubuntu/ramq_data/ramq_establishments_final.csv"
    ...
    while i < len(lines):
        ...
        if code_match:
            ...
            if current_code and current_name:
                ...
                print(f"  Extracted: {current_code} - {current_name} - {current_address} - Categories: {','.join(current_categories)}")
            ...
            # Reset address for new entry
            current_address = None
        else:
            # If this line doesn't start with a code and we have a current code,
            # it might be an address line
            if current_code and not current_address:
